...
import { Database, Tables } from '@/util/database.types';
import { getEssays } from '@/service/supabaseService';
import Link from 'next/link';
import { useRouter } from 'next/router';
import { setLogoutUser } from '@/service/apiCalls';
    ...
    return (
        <>
            <div className={`fixed top-0 left-0 h-full w-64 z-[10] bg-gray-800 text-white p-8 transition-transform duration-300 ease-in-out transform ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                ...
                <h2 className="text-2xl mb-8">            <Image src="/slay-white.png" alt="Slay Logo" width={64} height={32} />
